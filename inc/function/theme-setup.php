...
function wph_scripts()
{
    ...
    /*js*/
    wp_enqueue_script('mmenujs', $uri . '/assets/libs/mmenujs/js/mmenu.min.js', array('jquery'), false, true);
    wp_enqueue_script('cookie-js', $uri . '/assets/js/jquery.cookie-consent.js', array('jquery'), false, true);
    wp_enqueue_script('main', $uri . '/assets/js/main.js', array('jquery'), false, true);
}
